...
SPEC_BEGIN(CrunchyTacoStoreSpec)

describe(@"CrunchyTacoStore", ^{
    __block CrunchyTacoStore *tacoStore;
    ...
    beforeEach(^{
        ...
        tacoStore = [[CrunchyTacoStore alloc] init];
    ...
    it(@"is called 'Crunchy Taco Store'", ^{
        [[tacoStore.name should] equal:@"Crunchy Taco Store"];
    });
